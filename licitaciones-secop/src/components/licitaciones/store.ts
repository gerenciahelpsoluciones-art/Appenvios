import type { Licitacion, HitoProceso, DocumentoBase, EmpresaPerfil, RupData } from '../../types/licitaciones.types';
...
export function getRupData(): RupData {
  return load<RupData>(KEYS.rup, RUP_DEFAULT);
}

export function saveRupData(data: RupData): void {
  save(KEYS.rup, { ...data, ultima_actualizacion: new Date().toISOString() });
}
