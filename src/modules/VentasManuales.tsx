...
import type { VentaManual, Cliente, AppUser } from '../App';
...
const VentasManualesModule: React.FC<IProps> = ({ ventas, clientes, users, currentUser, onAdd, onDelete }) => {
                    ...
                    <div className="form-grid-modern">
                        ...
                        <div className="form-row">
                            <div className="form-group flex-2">
                                ...
                                >
                                    {users.filter(u => u.rol === 'Comercial' || u.rol === 'Admin').map(u => (
