        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {contrato.descripcion && contrato.descripcion.length > 120 && (
            <button
              ...
              style={{ background: 'none', border: 'none', color: 'hsl(var(--primary))', fontSize: '0.72rem', cursor: 'pointer', padding: 0, marginBottom: '0.25rem' }}
            >
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <button
            ...
            style={{
              ...
              background: loading ? 'rgba(239,68,68,0.2)' : '#ef4444',
              border: 'none',
              borderRadius: '8px',
              color: 'white',
              fontWeight: 700,
        ...
        <p style={{ margin: '0.5rem 0 0', fontSize: '0.75rem', color: 'hsl(var(--text-muted))' }}>
          💡 Tip: Busca por nombre parcial (ej: "Alcaldía Bogotá") o por NIT para ver todos sus contratos en SECOP.
        </p>
      </div>
